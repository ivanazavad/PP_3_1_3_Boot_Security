...
# Для создания первых пользователей Admin(с ролью admin, пароль Admin) и User1(с ролью user, пароль User1) автоматически выполняется скрипт во время запуска приложения.
